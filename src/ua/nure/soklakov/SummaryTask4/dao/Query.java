...
public class Query {
	...
	public static final String UPDATE_DIAGNOSIS = "UPDATE hospital_cards SET diagnosis = ? WHERE id = ?";
	public static final String CREATE_HOSPITAL_CARD = "INSERT INTO hospital_cards (diagnosis) VALUE (null)";
	public static final String INSERT_TREATMENT = "INSERT INTO treatments (hospital_card_id, type_of_treatment_id, name_of_medication) VALUES (?, ?, ?)";
	public static final String UPDATE_FINISH_TREATMENT = "UPDATE treatments SET done = 1 WHERE id = ?";
	public static final String SELECT_HOSPITAL_CARD_BY_ID = "SELECT * FROM hospital_cards WHERE id = ?";
	public static final String SELECT_TREATMENTS_BY_HOSPITAL_CARD = "SELECT * FROM treatments WHERE hospital_card_id = (?)";
	public static final String SELECT_ALL_TYPES_OF_TREATMENT = "SELECT * FROM types_of_treatment;";
